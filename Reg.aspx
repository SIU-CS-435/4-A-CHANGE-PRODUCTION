...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"  
            ...
            <td>
                &nbsp;</td><br />
&nbsp;</tr><tr><td class="auto-style1" style="font-size: x-large; font-weight: bold"><asp:Label ID="Label2" runat="server" Font-Size="x-Large" 
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
            ...
            <td>
                &nbsp;</td><br />
&nbsp;</tr><tr><td class="auto-style1" style="font-size: x-large; font-weight: bold"><asp:Label ID="Label4" runat="server" Font-Size="x-Large" Text="Password"></asp:Label>
            </td>
            <td>
...
ErrorMessage="Password must contain: Minimum 8 characters atleast 1 UpperCase Alphabet, 1 LowerCase Alphabet, 1 Number and 1 Special Character" ForeColor="Red" />
            ...
            <td>
                &nbsp;</td><br />
&nbsp;</tr><tr><td class="auto-style1" style="font-size: x-large; font-weight: bold"><asp:Label ID="Label6" runat="server" Font-Size="x-Large" Text="Registration Date"></asp:Label>
            </td>
            <td>
